...
class PDDL_Parser:
# I ADD FLUENTS AND NUMERIC-FLUENTS----> REVIEW
    SUPPORTED_REQUIREMENTS = [':strips', ':negative-preconditions', ':typing', ':fluents', ':numeric-fluents']
    ...
    #-----------------------------------------------
    # Parse functions (numeric fluents)
    #-----------------------------------------------
    ...
    def parse_action(self, group):
        ...
        self.actions[name] = Action(name, parameters, positive_preconditions, negative_preconditions, add_effects, del_effects, extensions)
